...
public class JwtFilter extends OncePerRequestFilter  {
	 ...
	 @Value(value = "${default.value.logging.log-request}")
	    private Boolean logRequest;

	    @Value(value = "${default.value.logging.log-response}")
	    ...
	    public void logRequestResponse(ContentCachingRequestWrapper requestWrapper,
	        ...
	        if (logRequest && allowedMethods.contains(method) && !path.contains("/login")) {
	            ...
	            log.info("REQUEST: \n[ENDPOINT] - {} {}\n[PAYLOAD] - {}", requestWrapper.getRequestURI(),
